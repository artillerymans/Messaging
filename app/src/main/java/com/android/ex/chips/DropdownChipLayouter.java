...
public class DropdownChipLayouter {
    ...
    protected void bindDrawableToDeleteView(final StateListDrawable drawable, String recipient,
        ...
        if (drawable == null) {
            ...
            view.setContentDescription(
                    res.getString(com.android.messaging.R.string.dropdown_delete_button_desc, recipient));
    ...
    protected @LayoutRes int getItemLayoutResId(AdapterType type) {
        switch (type) {
            case BASE_RECIPIENT:
                return com.android.messaging.R.layout.chips_autocomplete_recipient_dropdown_item;
            case RECIPIENT_ALTERNATES:
                return com.android.messaging.R.layout.chips_recipient_dropdown_item;
            default:
                return com.android.messaging.R.layout.chips_recipient_dropdown_item;
        }
    }
    ...
    protected @DrawableRes int getDefaultPhotoResId() {
        return com.android.messaging.R.drawable.ic_contact_picture;
    }
    ...
    protected @IdRes int getPersonGroupResId() {
        return com.android.messaging.R.id.chip_person_wrapper;
    }
    ...
    protected @IdRes int getPermissionGroupResId() {
        return com.android.messaging.R.id.chip_permission_wrapper;
    }
    ...
    protected class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            topDivider = view.findViewById(com.android.messaging.R.id.chip_autocomplete_top_divider);

            bottomDivider = view.findViewById(com.android.messaging.R.id.chip_autocomplete_bottom_divider);
            permissionBottomDivider = view.findViewById(com.android.messaging.R.id.chip_permission_bottom_divider);

            indicatorView = (TextView) view.findViewById(com.android.messaging.R.id.chip_indicator_text);
